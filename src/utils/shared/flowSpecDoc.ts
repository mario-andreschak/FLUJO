...
- { "key": "...", "type": "subflow", "label": "...",
    ...
    "allowCallerPrompt": true | false,             // optional, only with inputMode "isolated"; default true — a routing step may pass a "prompt" via its handoff tool that overrides the subflow's "prompt". Set false to forbid it
